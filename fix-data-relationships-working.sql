-- Fix Data Relationships (Working Version)
-- This script fixes relationships and adds test data with valid category values
...
-- Step 3: Add test complaints with valid category
