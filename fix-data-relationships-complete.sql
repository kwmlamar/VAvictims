-- Fix Data Relationships (Complete Version)
-- This script fixes relationships and adds test data with valid status and category values
...
-- Step 3: Add test complaints with valid status and category
