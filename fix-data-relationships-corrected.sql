-- Fix Data Relationships and Add Realistic Test Data (Corrected)
-- This script fixes the missing facility_id relationships and adds test data with correct status values
...
-- Step 3: Add realistic test complaints for existing facilities (with correct status values)
