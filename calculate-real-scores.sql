-- Calculate Real Scores for VA Accountability Platform
...
-- Step 4: Update or insert facility scorecards
...
-- Step 5: Update or insert VISN scorecards
INSERT INTO scorecards (entity_type, entity_id, score, data_summary, criteria)
SELECT 
    'visn' as entity_type,
    v.id as entity_id,
...
-- Step 6: Update or insert national scorecard
INSERT INTO scorecards (entity_type, entity_id, score, data_summary, criteria)
VALUES (
    'national',
