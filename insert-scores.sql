-- Insert Calculated Scores into Scorecards Table
-- This script calculates and inserts facility, VISN, and national scores

-- First, clear existing scorecards
DELETE FROM scorecards;

-- Calculate and insert facility scores
...
-- Calculate and insert VISN scores
INSERT INTO scorecards (entity_type, entity_id, score, created_at, updated_at)
SELECT 
  'visn' as entity_type,
  v.id as entity_id,
...
-- Calculate and insert national score
INSERT INTO scorecards (entity_type, entity_id, score, created_at, updated_at)
SELECT 
