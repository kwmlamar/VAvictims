-- Add Missing VISN and National Scores (Simple Version)
-- This script adds VISN and national scorecards that are missing
...
-- Show all scorecard types now in the table
SELECT 
  entity_type,
  COUNT(*) as count,
